              ...
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.email.$error" class="form-error">
                    <span v-if="!$v.form.email.required" class="help is-danger">Email required</span>
              ...
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.avatar.$error" class="form-error">
                    <span v-if="!$v.form.avatar.url" class="help is-danger">avatar URL Not valid!</span>
                    <span v-if="!$v.form.avatar.supportedFileType" class="help is-danger">seleted file type is Not valid!</span>
                  </div>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.password.$error" class="form-error">
                    <span v-if="!$v.form.password.required" class="help is-danger">Password required</span>
              ...
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.passwordConfirmation.$error" class="form-error">
                    <span v-if="!$v.form.passwordConfirmation.required" class="help is-danger">passwordConfirmation required</span>
                    <span v-if="!$v.form.passwordConfirmation.sameAsPassword" class="help is-danger">password Confirmation should be same as password</span>
                  </div>
                </div>
              </div>
